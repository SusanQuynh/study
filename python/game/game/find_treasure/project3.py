...
*******************************************************************************
''')
#get from https://ascii.co.uk/art

print("Welcome to Treasure Island. \nYour mission is to find the treasure.  ")
cross = input("You're at a cross road. Where do you want to go? Type 'left' or 'right \n").lower()
if cross == "left":
    lake = input("You come to a lake. There is an island in the middle of the lake. Type 'wait' to wait a boat. Type 'swim' to swim across.").lower()
    if lake == "wait":
